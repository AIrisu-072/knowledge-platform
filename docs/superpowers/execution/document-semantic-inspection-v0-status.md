...
- Exact next action: obtain hosted DSI PoC GREEN for this PoC promotion head, finish root workspace tests, strict Clippy, and independent review, then commit bounded production PPTX adapter and require same-head standard CI, Sandbox, and PoC SUCCESS. Keep PR #10 Draft and unmerged; no Design amendment is in progress.
