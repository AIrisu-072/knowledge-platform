...
- Exact next action: commit/push the prepared Task 8 Step 3 signature test-only RED, obtain clean exact-head standard CI/Sandbox/PoC evidence, then add supplemental signed-package part coverage RED if needed before Step 4 GREEN. Keep PR #10 OPEN/Draft and unmerged.
